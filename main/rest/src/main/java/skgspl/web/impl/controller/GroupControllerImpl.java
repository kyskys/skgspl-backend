...
import skgspl.service.api.GroupService;import skgspl.service.api.UserService;
import skgspl.web.dto.group.GroupCreateDto;
import skgspl.web.dto.group.GroupDto;
import skgspl.web.dto.group.GroupGetDto;
...
public class GroupControllerImpl {
	...
	@RequestMapping(value = "{group}/add/lesson/{lesson}", method = RequestMethod.GET)
	public void addPairToGroup(@PathVariable("lesson") Long idPair, @PathVariable("group") Long idGroup) {
		groupService.addLessonToGroup(idPair, idGroup);
	}

	@RequestMapping(value = "{group}/remove/lesson/{lesson}", method = RequestMethod.GET)
	public void removePairFromGroup(@PathVariable("lesson") Long idPair, @PathVariable("group") Long idGroup) {
...
//	public List<GroupGetDto> getGroupsByLessonId(@PathVariable("pair") Long idPair) {
//		List<GroupGetDto> result = groupService.getGroupsByLessonId(idPair).stream().map(GroupGetDto::new)
//				.collect(Collectors.toList());
//		return result;
//	}
//
//	@RequestMapping(value = "/nolesson/{lesson}", method = RequestMethod.GET)
//	public List<GroupGetDto> getGroupsWithoutLesson(@PathVariable("pair") Long idPair) {
//		List<GroupGetDto> result = groupService.getGroupsWithoutLesson(idPair).stream().map(GroupGetDto::new)
//				.collect(Collectors.toList());
//		return result;
//	}
}
